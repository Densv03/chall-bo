...
export const Login = () => {
    ...
    function updateLoginForm<T extends keyof LoginForm>(field: T, value: string): void {
    ...
    return (
        <div className={'login-form-container'}>
            ...
            <form onSubmit={submitForm}>
                <ChallInput type={"text"} label={'Login'}
                            theme={InputThemeEnum.BACKGROUND_WHITE}
                            placeholder={'Input your login'}
                            onChange={(e) => updateLoginForm('login', e.target.value)}
                            required={true}/>
                <ChallInput type={"password"} label={'Password'}
                            theme={InputThemeEnum.BACKGROUND_WHITE}
                            placeholder={'Enter your password'}
                            onChange={(e) => updateLoginForm('password', e.target.value)} required={true}/>
